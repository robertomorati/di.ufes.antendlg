...
class TipoObjeto(models.Model):
    ...
    """
    Classe que representa um tipo de objeto.

    posicoes_geograficas: remete a quantidade de posições geográficas
                         que a instância do tipo pode ter.
    """
...
class Icone (models.Model):
    ...
    """
    Classe que presenta gráficamente um objeto no mapa.

    TODO: Redimensionar o icone para tamanho padrão.
    """
...
class Objeto (models.Model):
    ...
    """
    Classe que representa um objeto, como personagem, placas, animais etc.

    quantidade: quantida de instânciados que pode ter do respectivo objeto no mapa.
    coletavel: informa se o objeto pode ser coletado na aventura pelo jogador.

    TODO: Add public or private field.
    """
    nome = models.CharField(max_length=30)
    descricao = models.CharField(max_length=100)
...
class Autor(User, models.Model):
    ...
    """
    Classe que representa o autor/criador de uma aventura.
    """
...
class Aventura(models.Model):
    ...
    """
    Classe que representa uma aventura.
    """
...
class Sugestao(models.Model):
    ...
    """
    Class que representa uma sugestão.
    A sugestão é um elemento de percepção para uma instância de objeto.

    TODO:  Identificar tipos de arquivos e atualizar a forma de criar sugestões.
    """
...
class SugestaoFile(Sugestao, models.Model):
    ...
    """
    Classe que representa a sugestão em forma de arquivo (aúdio ou imagem).
    """
    sugestao = models.FileField(upload_to='sugestao/', help_text="Sugestão para auxiliar na decisão do jogador.", default="",)
...
class SugestaoMensagem(Sugestao, models.Model):
    ...
    """
    CLasse que representa a sugestão em forma de mensagem textual.
    """
...
class TipoImagem(models.Model):
    ...
    """
    Classe que representa o tipo de imagem para instância de objeto no modo player.
...
class InstanciaObjeto(models.Model):
    ...
    """
    Classe que representa uma instância de objeto.

    TODO: Rever o atributo sugestão; Adicionar relação com a aventura;
    """
    DESABILITADO = 'DS'
    AVATAR = 'AV'
    AGENTE = 'AG'
...
class PosicaoGeografica(models.Model):
    ...
    """
    Classe que representa uma posição geográfica.
    """
...
class Jogador(User, models.Model):
    ...
    """
    Classe que representa um jogador cadastrado com seu dispositivo móvel.
    """
...
class AventuraAtiva(models.Model):
    ...
    """
    Classe que representa uma aventura está ativa ou não. Ou seja, aventura habilitada para o modo player.
    """
...
class PosInstanciaAtiva(models.Model):
    ...
    """
    Classe que representa instâncias de aventuras que estão ativas, ou seja, aventuras sendo jogadas.
    """
    latitude = models.FloatField()
    longitude = models.FloatField()
    altitude = models.FloatField()
...
class Avatar(models.Model):
    ...
    """
    Classe que representa os persongens criados para uma determinada aventura.
    """
    nome = models.CharField(max_length=30)
...
class AvatarAtivo(models.Model):
    ...
    """
    Classe que persiste os dados de um avataar ativo.
    """
...
class Enredo(models.Model):
    ...
    """
    Classe que representa um elemento de feedback para o jogador.
    """
    # TEXTO = 'STX'
    # AUDIO = 'SAU'
    # IMGC = 'IMGC'
...
class EnredoFile(Enredo, models.Model):
    ...
    """
    Classe que representa imagem audio.
    """
    AUDIO = 'SAU'
    IMGC = 'IMGC'
    IMGM = 'IMGM'
...
class EnredoInstancia(Enredo, models.Model):
    ...
    """
    Classe que representa uma intância como enredo (comida, por exemplo).
    """
...
class EnredoMensagem(Enredo, models.Model):
    ...
    """
    Classe que representa um enredo como mensagem
    """
...
class Missao(models.Model):
    ...
    """
    Classe que representa algo que o jogador deve fazer. Uma missão possui um conjunto de 1 - n condições para ser completada.
    """
    nome = models.CharField(max_length=30, default="",)
...
class MissaoAtiva(models.Model):
    ...
    """
    Classe que  representa persistencia de dados de ma missão ativa
    """
...
class Condicao(models.Model):
    ...
    """
    Classe que representa atributos comuns para os três tipos de conções definidas no trabalho.
    """
...
class CondicaoAtiva(models.Model):
    ...
    """
    Classe que representa condicao ativa
    """
...
class CondicaoInstanciaObjeto(Condicao, models.Model):
    ...
    """
    Classe que representa a necessidade de relação entre dois objetos para satisfazer uma condição.
    """
...
class CondicaoJogadorInstancia(Condicao, models.Model):
    ...
    """
    Classe que estabelece a condicao entre um Avatar de um jogador e um item (instancia Objeto)
    """
...
class CondicaoJogadorObjeto(Condicao, models.Model):
    ...
    """
    Classe que estabelece a condicao entre um Avatar de um jogador e Objeto
    """
...
class CondicaoDialogoInstancia(Condicao, models.Model):
    ...
    """
    Classe que representa a condição que envolve tipos de dialogo, que são Dialogo Inicial, Dialogo Final, confirmação e negacao.
    """
...
class Agente(models.Model):
    ...
    """
    Classe que representa um agente e seu tipo de comportamento.
    """
    AGRESSIVO = 'Agressivo'
    PASSIVO = 'Passivo'
...
class Comportamento(models.Model):
    ...
    """
    Classe que reoresenta o corportamento de um agente.
    """
...
class Agressivo(Comportamento, models.Model):
    ...
    """
    Classe que representa o comportamento agressivo
    """
...
class Passivo(Comportamento, models.Model):
    ...
    """
    Classe que representa o comportamento Passivo.
    """
    # avatar_vit = models.ForeignKey(Avatar,related_name="avatar_vit", blank=True, default="", null=True,)
    pass
...
class Colaborativo(Comportamento, models.Model):
    ...
    """
    Classe que representa o comportamento colaborativo.
    """
...
class Competitivo(Comportamento, models.Model):
    ...
    """
    Classe que representa o comportamento competitivo.
    """
...
class Mensagem(models.Model):
    ...
    """
    Classe que representa uma mensagem para comportamentos colaborativo ou competitivo.
    """
...
class Mochila(models.Model):
    ...
    """
    Classe que representa os itens do avatar do jogador são guardados na mochila
    """
