...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AventuraAtiva.descricao'
        db.delete_column('editor_objetos_aventuraativa', 'descricao')

        # Adding field 'AventuraAtiva.chave_acesso'
        db.add_column('editor_objetos_aventuraativa', 'chave_acesso',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AventuraAtiva.descricao'
        db.add_column('editor_objetos_aventuraativa', 'descricao',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=200),
                      keep_default=False)

        # Deleting field 'AventuraAtiva.chave_acesso'
        db.delete_column('editor_objetos_aventuraativa', 'chave_acesso')
