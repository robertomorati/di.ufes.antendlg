...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('editor_objetos_condicaojogador', (
            ...
            ('prefixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='prefixo_cj_avateres', null=True, blank=True, to=orm['editor_objetos.Avatar'])),
            ('sufixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='sufixo_cj_inst_obj', null=True, blank=True, to=orm['editor_objetos.InstanciaObjeto'])),
            ('quandidade', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=3)),
        ))
        db.send_create_signal('editor_objetos', ['CondicaoJogador'])

        # Adding model 'Enredo'
        db.create_table('editor_objetos_enredo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(default='', max_length=30)),
            ('tipo', self.gf('django.db.models.fields.CharField')(default='STX', max_length=10)),
            ('enredo', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100)),
            ('descricao', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
        ))
        db.send_create_signal('editor_objetos', ['Enredo'])
        ...
        db.create_table('editor_objetos_condicaodialogo', (
            ('condicao_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editor_objetos.Condicao'], unique=True, primary_key=True)),
            ('prexifo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='prefixo_cd_avateres', null=True, blank=True, to=orm['editor_objetos.Avatar'])),
            ('sufixo', self.gf('django.db.models.fields.CharField')(default='DIALOGO_INICIAL', max_length=10)),
        ))
        db.send_create_signal('editor_objetos', ['CondicaoDialogo'])

        # Adding model 'Avatar'
        db.create_table('editor_objetos_avatar', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('editor_objetos', ['Avatar'])

        # Adding model 'Condicao'
        db.create_table('editor_objetos_condicao', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ligacao', self.gf('django.db.models.fields.CharField')(default='', max_length=30)),
            ('evento', self.gf('django.db.models.fields.CharField')(default='GET_OBJ', max_length=10)),
            ('enredo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='enredos', null=True, blank=True, to=orm['editor_objetos.Enredo'])),
        ))
        db.send_create_signal('editor_objetos', ['Condicao'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('editor_objetos_enredo')
        ...
        db.delete_table('editor_objetos_avatar')

        # Deleting model 'Condicao'
        db.delete_table('editor_objetos_condicao')
    ...
    models = {
        ...
        'editor_objetos.condicao': {
            ...
            'evento': ('django.db.models.fields.CharField', [], {'default': "'GET_OBJ'", 'max_length': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ligacao': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'})
        },
        'editor_objetos.condicaodialogo': {
            ...
            'prexifo': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'prefixo_cd_avateres'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Avatar']"}),
        ...
        'editor_objetos.condicaojogador': {
            ...
            'quandidade': ('django.db.models.fields.IntegerField', [], {'default': '1', 'max_length': '3'}),
