...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AventuraAtiva.instancia'
        db.add_column('editor_objetos_aventuraativa', 'instancia',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AventuraAtiva.instancia'
        db.delete_column('editor_objetos_aventuraativa', 'instancia')
