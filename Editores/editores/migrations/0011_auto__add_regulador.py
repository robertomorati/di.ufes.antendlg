...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'editores_regulador', (
            (u'profissional_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editores.Profissional'], unique=True, primary_key=True)),
    ...
    models = {
        ...
        u'editores.regulador': {
            'Meta': {'object_name': 'Regulador', '_ormbases': [u'editores.Profissional']},
            'especialidade': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            u'profissional_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['editores.Profissional']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'editores.sugestao': {
