...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Agente.comportamento'
        db.alter_column('editor_objetos_agente', 'comportamento', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Agente.comportamento'
        db.alter_column('editor_objetos_agente', 'comportamento', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        'editor_objetos.agente': {
            ...
            'comportamento': ('django.db.models.fields.CharField', [], {'default': "'Agressivo'", 'max_length': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
