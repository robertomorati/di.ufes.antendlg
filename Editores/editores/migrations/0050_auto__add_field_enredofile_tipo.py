...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnredoFile.tipo'
        db.add_column('editor_objetos_enredofile', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default='SAU', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnredoFile.tipo'
        db.delete_column('editor_objetos_enredofile', 'tipo')
