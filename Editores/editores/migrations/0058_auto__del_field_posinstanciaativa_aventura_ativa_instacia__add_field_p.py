...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PosInstanciaAtiva.aventura_ativa_instacia'
        db.delete_column('editor_objetos_posinstanciaativa', 'aventura_ativa_instacia_id')

        # Adding field 'PosInstanciaAtiva.aventura_ativa_instancia'
        db.add_column('editor_objetos_posinstanciaativa', 'aventura_ativa_instancia',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='aventura_ativa_instancia', blank=True, to=orm['editor_objetos.AventuraAtiva']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PosInstanciaAtiva.aventura_ativa_instacia'
        db.add_column('editor_objetos_posinstanciaativa', 'aventura_ativa_instacia',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='aventura_ativa_instacia', to=orm['editor_objetos.AventuraAtiva'], blank=True),
                      keep_default=False)

        # Deleting field 'PosInstanciaAtiva.aventura_ativa_instancia'
        db.delete_column('editor_objetos_posinstanciaativa', 'aventura_ativa_instancia_id')
    ...
    models = {
        ...
        'editor_objetos.avatarativo': {
            ...
            'avatar': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'avatar_ativo'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Avatar']"}),
        ...
        'editor_objetos.posinstanciaativa': {
            ...
            'altitude': ('django.db.models.fields.FloatField', [], {}),
            'aventura_ativa_instancia': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'aventura_ativa_instancia'", 'blank': 'True', 'to': "orm['editor_objetos.AventuraAtiva']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
