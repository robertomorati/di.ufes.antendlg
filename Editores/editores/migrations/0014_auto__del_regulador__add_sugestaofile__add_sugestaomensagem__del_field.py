...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Regulador'
        db.delete_table(u'editores_regulador')
        ...
        db.create_table(u'editores_sugestaomensagem', (
            (u'sugestao_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editores.Sugestao'], unique=True, primary_key=True)),
            ('mensagem', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal(u'editores', ['SugestaoMensagem'])

        # Deleting field 'Sugestao.sugestao'
        db.delete_column(u'editores_sugestao', 'sugestao')


    def backwards(self, orm):
        # Adding model 'Regulador'
        db.create_table(u'editores_regulador', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('especialidade', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'editores', ['Regulador'])
        ...
        db.add_column(u'editores_sugestao', 'sugestao',
    ...
    models = {
        ...
        u'editores.sugestaomensagem': {
            ...
            'mensagem': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            u'sugestao_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['editores.Sugestao']", 'unique': 'True', 'primary_key': 'True'})
        },
