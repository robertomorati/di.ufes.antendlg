...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CondicaoDialogo.referencia_sufixo'
        db.add_column('editor_objetos_condicaodialogo', 'referencia_sufixo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='ref_sufixo_cd_inst_obj', null=True, blank=True, to=orm['editor_objetos.InstanciaObjeto']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CondicaoDialogo.referencia_sufixo'
        db.delete_column('editor_objetos_condicaodialogo', 'referencia_sufixo_id')
