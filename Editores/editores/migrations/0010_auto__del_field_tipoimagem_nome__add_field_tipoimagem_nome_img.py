...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TipoImagem.nome'
        db.delete_column('editor_objetos_tipoimagem', 'nome')

        # Adding field 'TipoImagem.nome_img'
        db.add_column('editor_objetos_tipoimagem', 'nome_img',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TipoImagem.nome'
        db.add_column('editor_objetos_tipoimagem', 'nome',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Deleting field 'TipoImagem.nome_img'
        db.delete_column('editor_objetos_tipoimagem', 'nome_img')
