...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InstanciaObjeto.sugestao'
        db.delete_column('editor_objetos_instanciaobjeto', 'sugestao_id')

        # Adding field 'InstanciaObjeto.sugestao_objeto'
        db.add_column('editor_objetos_instanciaobjeto', 'sugestao_objeto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='sugestoes', null=True, blank=True, to=orm['editor_objetos.Sugestao']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'InstanciaObjeto.sugestao'
        db.add_column('editor_objetos_instanciaobjeto', 'sugestao',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='sugestao_objeto', null=True, to=orm['editor_objetos.Sugestao'], blank=True),
                      keep_default=False)

        # Deleting field 'InstanciaObjeto.sugestao_objeto'
        db.delete_column('editor_objetos_instanciaobjeto', 'sugestao_objeto_id')
