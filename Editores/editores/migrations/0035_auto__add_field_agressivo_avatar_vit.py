...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agressivo.avatar_vit'
        db.add_column('editor_objetos_agressivo', 'avatar_vit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='avatar_vit', null=True, blank=True, to=orm['editor_objetos.Avatar']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agressivo.avatar_vit'
        db.delete_column('editor_objetos_agressivo', 'avatar_vit_id')
