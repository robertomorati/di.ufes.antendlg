...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agente.aventura_agente'
        db.add_column('editor_objetos_agente', 'aventura_agente',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='aventura_agente', null=True, blank=True, to=orm['editor_objetos.Aventura']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agente.aventura_agente'
        db.delete_column('editor_objetos_agente', 'aventura_agente_id')
