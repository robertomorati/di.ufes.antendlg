...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Colaborativo.avatar_col'
        db.add_column('editor_objetos_colaborativo', 'avatar_col',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='avatar_col', null=True, blank=True, to=orm['editor_objetos.Avatar']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Colaborativo.avatar_col'
        db.delete_column('editor_objetos_colaborativo', 'avatar_col_id')
