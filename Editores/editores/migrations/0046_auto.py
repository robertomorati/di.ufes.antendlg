...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('editor_objetos_aventuraativa_joadores_aventura_ativa')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('aventuraativa', models.ForeignKey(orm['editor_objetos.aventuraativa'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('editor_objetos_aventuraativa_joadores_aventura_ativa'))
