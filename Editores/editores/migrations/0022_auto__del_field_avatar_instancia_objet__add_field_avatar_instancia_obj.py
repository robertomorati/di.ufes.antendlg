...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Avatar.instancia_objet'
        db.delete_column('editor_objetos_avatar', 'instancia_objet_id')

        # Adding field 'Avatar.instancia_objeto'
        db.add_column('editor_objetos_avatar', 'instancia_objeto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='instancia_objeto', null=True, blank=True, to=orm['editor_objetos.InstanciaObjeto']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Avatar.instancia_objet'
        db.add_column('editor_objetos_avatar', 'instancia_objet',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='instancia_objeto', null=True, to=orm['editor_objetos.InstanciaObjeto'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'editor_objetos.avatar': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instancia_objeto': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'instancia_objeto'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.InstanciaObjeto']"}),
