...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Jogador.distancia'
        db.add_column(u'editores_jogador', 'distancia',
                      self.gf('django.db.models.fields.IntegerField')(default=500, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Jogador.distancia'
        db.delete_column(u'editores_jogador', 'distancia')
