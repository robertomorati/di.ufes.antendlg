...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Condicao.operador'
        db.add_column('editor_objetos_condicao', 'operador',
                      self.gf('django.db.models.fields.CharField')(default='AND', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Condicao.operador'
        db.delete_column('editor_objetos_condicao', 'operador')
