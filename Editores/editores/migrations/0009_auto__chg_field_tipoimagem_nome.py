...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TipoImagem.nome'
        db.alter_column('editor_objetos_tipoimagem', 'nome', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'TipoImagem.nome'
        db.alter_column('editor_objetos_tipoimagem', 'nome', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
