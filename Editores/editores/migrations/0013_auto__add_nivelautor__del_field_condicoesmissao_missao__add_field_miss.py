...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('editor_objetos_nivelautor', (
            ...
            ('autor', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='autor', null=True, blank=True, to=orm['editor_objetos.Autor'])),
        ...
        # Deleting field 'CondicoesMissao.missao'
        db.delete_column('editor_objetos_condicoesmissao', 'missao_id')

        # Adding field 'Missao.tempo'
        db.add_column('editor_objetos_missao', 'tempo',
                      self.gf('django.db.models.fields.TimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Condicao.nome'
        db.add_column('editor_objetos_condicao', 'nome',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'CondicoesMissao.missao'
        db.add_column('editor_objetos_condicoesmissao', 'missao',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='missoes', null=True, to=orm['editor_objetos.Missao'], blank=True),
                      keep_default=False)

        # Deleting field 'Missao.tempo'
        db.delete_column('editor_objetos_missao', 'tempo')

        # Deleting field 'Condicao.nome'
        db.delete_column('editor_objetos_condicao', 'nome')
    ...
    models = {
        ...
        'editor_objetos.missao': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'}),
            'tempo': ('django.db.models.fields.TimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'})
        },
