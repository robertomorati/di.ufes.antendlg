...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SugestaoFile'
        db.create_table(u'editores_sugestaofile', (
            (u'sugestao_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editores.Sugestao'], unique=True, primary_key=True)),
            ('sugestao', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100)),
            ('tipo', self.gf('django.db.models.fields.CharField')(default=u'SAU', max_length=10)),
            ('descricao', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'editores', ['SugestaoFile'])
        ...
        db.create_table(u'editores_sugestao', (
            ...
            ('aventura_sugestao', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='aventura_sugestao', null=True, blank=True, to=orm['editores.Aventura'])),
        ))
        db.send_create_signal(u'editores', ['Sugestao'])

        # Adding model 'SugestaoMensagem'
        db.create_table(u'editores_sugestaomensagem', (
            (u'sugestao_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editores.Sugestao'], unique=True, primary_key=True)),
            ('sugestao', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal(u'editores', ['SugestaoMensagem'])

        # Adding field 'InstanciaObjeto.sugestao_objeto'
        db.add_column(u'editores_instanciaobjeto', 'sugestao_objeto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='sugestoes', null=True, blank=True, to=orm['editores.Sugestao']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SugestaoFile'
        db.delete_table(u'editores_sugestaofile')

        # Deleting model 'Sugestao'
        db.delete_table(u'editores_sugestao')

        # Deleting model 'SugestaoMensagem'
        db.delete_table(u'editores_sugestaomensagem')

        # Deleting field 'InstanciaObjeto.sugestao_objeto'
        db.delete_column(u'editores_instanciaobjeto', 'sugestao_objeto_id')
    ...
    models = {
        ...
        u'editores.sugestao': {
            ...
            'aventura_sugestao': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'aventura_sugestao'", 'null': 'True', 'blank': 'True', 'to': u"orm['editores.Aventura']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'}),
            'proximidade': ('django.db.models.fields.IntegerField', [], {'default': '1', 'max_length': '3'}),
            'publico': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'editores.sugestaofile': {
            'Meta': {'object_name': 'SugestaoFile', '_ormbases': [u'editores.Sugestao']},
            'descricao': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'sugestao': ('django.db.models.fields.files.FileField', [], {'default': "''", 'max_length': '100'}),
            u'sugestao_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['editores.Sugestao']", 'unique': 'True', 'primary_key': 'True'}),
            'tipo': ('django.db.models.fields.CharField', [], {'default': "u'SAU'", 'max_length': '10'})
        },
        u'editores.sugestaomensagem': {
            'Meta': {'object_name': 'SugestaoMensagem', '_ormbases': [u'editores.Sugestao']},
            'sugestao': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            u'sugestao_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['editores.Sugestao']", 'unique': 'True', 'primary_key': 'True'})
        },
