...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SugestaoFile.tipo'
        db.add_column(u'editores_sugestaofile', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default=u'SAU', max_length=10),
                      keep_default=False)

        # Deleting field 'Sugestao.tipo'
        db.delete_column(u'editores_sugestao', 'tipo')


    def backwards(self, orm):
        # Deleting field 'SugestaoFile.tipo'
        db.delete_column(u'editores_sugestaofile', 'tipo')

        # Adding field 'Sugestao.tipo'
        db.add_column(u'editores_sugestao', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default=u'STX', max_length=10),
                      keep_default=False)
