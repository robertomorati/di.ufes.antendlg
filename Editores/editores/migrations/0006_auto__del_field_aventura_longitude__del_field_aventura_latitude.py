...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Aventura.longitude'
        db.delete_column(u'editores_aventura', 'longitude')

        # Deleting field 'Aventura.latitude'
        db.delete_column(u'editores_aventura', 'latitude')


    def backwards(self, orm):
        # Adding field 'Aventura.longitude'
        db.add_column(u'editores_aventura', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, blank=True),
                      keep_default=False)

        # Adding field 'Aventura.latitude'
        db.add_column(u'editores_aventura', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, blank=True),
                      keep_default=False)
