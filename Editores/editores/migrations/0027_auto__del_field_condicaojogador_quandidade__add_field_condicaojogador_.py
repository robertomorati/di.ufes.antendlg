...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CondicaoJogador.quandidade'
        db.delete_column('editor_objetos_condicaojogador', 'quandidade')

        # Adding field 'CondicaoJogador.quantidade'
        db.add_column('editor_objetos_condicaojogador', 'quantidade',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=3),
                      keep_default=False)

        # Deleting field 'CondicaoDialogo.prexifo'
        db.delete_column('editor_objetos_condicaodialogo', 'prexifo_id')

        # Adding field 'CondicaoDialogo.prefixo'
        db.add_column('editor_objetos_condicaodialogo', 'prefixo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='prefixo_cd_avateres', null=True, blank=True, to=orm['editor_objetos.Avatar']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CondicaoJogador.quandidade'
        db.add_column('editor_objetos_condicaojogador', 'quandidade',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=3),
                      keep_default=False)

        # Deleting field 'CondicaoJogador.quantidade'
        db.delete_column('editor_objetos_condicaojogador', 'quantidade')

        # Adding field 'CondicaoDialogo.prexifo'
        db.add_column('editor_objetos_condicaodialogo', 'prexifo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='prefixo_cd_avateres', null=True, to=orm['editor_objetos.Avatar'], blank=True),
                      keep_default=False)

        # Deleting field 'CondicaoDialogo.prefixo'
        db.delete_column('editor_objetos_condicaodialogo', 'prefixo_id')
