...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CondicaoDialogo'
        db.delete_table('editor_objetos_condicaodialogo')

        # Adding model 'CondicaoDialogoInstancia'
        db.create_table('editor_objetos_condicaodialogoinstancia', (
            ...
            ('prefixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='prefixo_cd_avateres', null=True, blank=True, to=orm['editor_objetos.Avatar'])),
            ('sufixo', self.gf('django.db.models.fields.CharField')(default='DIALOGO_INICIAL', max_length=20)),
            ('referencia_sufixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='ref_sufixo_cd_inst_obj', null=True, blank=True, to=orm['editor_objetos.InstanciaObjeto'])),
        ))
        db.send_create_signal('editor_objetos', ['CondicaoDialogoInstancia'])


    def backwards(self, orm):
        # Adding model 'CondicaoDialogo'
        db.create_table('editor_objetos_condicaodialogo', (
            ('prefixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='prefixo_cd_avateres', null=True, to=orm['editor_objetos.Avatar'], blank=True)),
            ('condicao_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editor_objetos.Condicao'], unique=True, primary_key=True)),
            ('sufixo', self.gf('django.db.models.fields.CharField')(default='DIALOGO_INICIAL', max_length=20)),
            ('referencia_sufixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='ref_sufixo_cd_inst_obj', null=True, to=orm['editor_objetos.InstanciaObjeto'], blank=True)),
        ))
        db.send_create_signal('editor_objetos', ['CondicaoDialogo'])

        # Deleting model 'CondicaoDialogoInstancia'
        db.delete_table('editor_objetos_condicaodialogoinstancia')
    ...
    models = {
        ...
        'editor_objetos.condicaodialogoinstancia': {
            'Meta': {'object_name': 'CondicaoDialogoInstancia', '_ormbases': ['editor_objetos.Condicao']},
