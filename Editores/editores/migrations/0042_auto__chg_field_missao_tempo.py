...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Missao.tempo'
        db.alter_column('editor_objetos_missao', 'tempo', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Missao.tempo'
        db.alter_column('editor_objetos_missao', 'tempo', self.gf('django.db.models.fields.TimeField')(null=True))
