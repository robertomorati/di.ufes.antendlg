...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CondicaoObjeto'
        db.delete_table('editor_objetos_condicaoobjeto')

        # Deleting model 'CondicaoJogador'
        db.delete_table('editor_objetos_condicaojogador')

        # Adding model 'Mochila'
        db.create_table('editor_objetos_mochila', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('avatar_mochila', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='avatar_mochila', null=True, blank=True, to=orm['editor_objetos.AvatarAtivo'])),
        ))
        db.send_create_signal('editor_objetos', ['Mochila'])

        # Adding M2M table for field instancia_mochila on 'Mochila'
        m2m_table_name = db.shorten_name('editor_objetos_mochila_instancia_mochila')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mochila', models.ForeignKey(orm['editor_objetos.mochila'], null=False)),
        ...
        db.create_table('editor_objetos_condicaojogadorobjeto', (
            ('condicao_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editor_objetos.Condicao'], unique=True, primary_key=True)),
            ('prefixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='prefixo_cjo_avateres', null=True, blank=True, to=orm['editor_objetos.Avatar'])),
            ('sufixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='sufixo_cjo__obj', null=True, blank=True, to=orm['editor_objetos.Objeto'])),
            ('quantidade', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=3)),
        ))
        db.send_create_signal('editor_objetos', ['CondicaoJogadorObjeto'])

        # Adding model 'CondicaoInstanciaObjeto'
        db.create_table('editor_objetos_condicaoinstanciaobjeto', (
            ('condicao_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editor_objetos.Condicao'], unique=True, primary_key=True)),
            ('prefixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='prefixo_co_inst_obj', null=True, blank=True, to=orm['editor_objetos.InstanciaObjeto'])),
            ('sufixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='sufixo_co_inst_obj', null=True, blank=True, to=orm['editor_objetos.InstanciaObjeto'])),
        ))
        db.send_create_signal('editor_objetos', ['CondicaoInstanciaObjeto'])

        # Adding model 'CondicaoJogadorInstancia'
        db.create_table('editor_objetos_condicaojogadorinstancia', (
            ('condicao_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editor_objetos.Condicao'], unique=True, primary_key=True)),
            ('prefixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='prefixo_cji_avateres', null=True, blank=True, to=orm['editor_objetos.Avatar'])),
            ('sufixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='sufixo_cji_inst_obj', null=True, blank=True, to=orm['editor_objetos.InstanciaObjeto'])),
        ))
        db.send_create_signal('editor_objetos', ['CondicaoJogadorInstancia'])


    def backwards(self, orm):
        # Adding model 'CondicaoObjeto'
        db.create_table('editor_objetos_condicaoobjeto', (
            ('prefixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='prefixo_co_inst_obj', null=True, to=orm['editor_objetos.InstanciaObjeto'], blank=True)),
            ('condicao_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editor_objetos.Condicao'], unique=True, primary_key=True)),
            ('sufixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='sufixo_co_inst_obj', null=True, to=orm['editor_objetos.InstanciaObjeto'], blank=True)),
        ))
        db.send_create_signal('editor_objetos', ['CondicaoObjeto'])

        # Adding model 'CondicaoJogador'
        db.create_table('editor_objetos_condicaojogador', (
            ('prefixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='prefixo_cj_avateres', null=True, to=orm['editor_objetos.Avatar'], blank=True)),
            ('condicao_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editor_objetos.Condicao'], unique=True, primary_key=True)),
            ('quantidade', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=3)),
            ('sufixo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='sufixo_cj_inst_obj', null=True, to=orm['editor_objetos.InstanciaObjeto'], blank=True)),
        ))
        db.send_create_signal('editor_objetos', ['CondicaoJogador'])

        # Deleting model 'Mochila'
        db.delete_table('editor_objetos_mochila')

        # Removing M2M table for field instancia_mochila on 'Mochila'
        db.delete_table(db.shorten_name('editor_objetos_mochila_instancia_mochila'))

        # Deleting model 'CondicaoJogadorObjeto'
        db.delete_table('editor_objetos_condicaojogadorobjeto')

        # Deleting model 'CondicaoInstanciaObjeto'
        db.delete_table('editor_objetos_condicaoinstanciaobjeto')

        # Deleting model 'CondicaoJogadorInstancia'
        db.delete_table('editor_objetos_condicaojogadorinstancia')
    ...
    models = {
        ...
        'editor_objetos.agente': {
            ...
            'aventura_agente': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'aventura_agente'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Aventura']"}),
        ...
        'editor_objetos.agressivo': {
            'Meta': {'object_name': 'Agressivo', '_ormbases': ['editor_objetos.Comportamento']},
            'avatar_vit': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'avatar_vit'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Avatar']"}),
            ...
            'item': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'instancia_agressivo'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.InstanciaObjeto']"})
        },
        ...
        'editor_objetos.avatar': {
            ...
            'avatar_ativo': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'avatar_ativo'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.AvatarAtivo']"}),
        ...
        'editor_objetos.avatarativo': {
            'Meta': {'object_name': 'AvatarAtivo'},
            'aventura_ativa_avatar': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'aventura_ativa_avatar'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.AventuraAtiva']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'editor_objetos.aventuraativa': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joadores_aventura_ativa': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'joadores_aventura_ativa'", 'default': "''", 'to': "orm['editor_objetos.Jogador']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'publica': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        'editor_objetos.colaborativo': {
            'Meta': {'object_name': 'Colaborativo', '_ormbases': ['editor_objetos.Comportamento']},
            'avatar_col': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'avatar_col'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Avatar']"}),
            'comportamento_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['editor_objetos.Comportamento']", 'unique': 'True', 'primary_key': 'True'}),
            'obstaculoscl': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'obstaculoscl'", 'default': "''", 'to': "orm['editor_objetos.InstanciaObjeto']", 'through': "orm['editor_objetos.Mensagem']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'})
        },
        'editor_objetos.competitivo': {
            'Meta': {'object_name': 'Competitivo', '_ormbases': ['editor_objetos.Comportamento']},
            'avatar_comp': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'avatar_comp'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Avatar']"}),
            'comportamento_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['editor_objetos.Comportamento']", 'unique': 'True', 'primary_key': 'True'}),
            'obstaculoscp': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'obstaculoscp'", 'default': "''", 'to': "orm['editor_objetos.InstanciaObjeto']", 'through': "orm['editor_objetos.Mensagem']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'})
        },
        ...
        'editor_objetos.condicaoativa': {
            'Meta': {'object_name': 'CondicaoAtiva'},
            'aventura_ativa_condicao': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'aventura_ativa_condicao'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.AventuraAtiva']"}),
            'condicao': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'condicao'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Condicao']"}),
            'estado_condicao': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'missao_ativa': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'missao_ativa'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.MissaoAtiva']"})
        },
        ...
        'editor_objetos.condicaoinstanciaobjeto': {
            'Meta': {'object_name': 'CondicaoInstanciaObjeto', '_ormbases': ['editor_objetos.Condicao']},
            'condicao_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['editor_objetos.Condicao']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'editor_objetos.condicaojogadorinstancia': {
            'Meta': {'object_name': 'CondicaoJogadorInstancia', '_ormbases': ['editor_objetos.Condicao']},
            'condicao_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['editor_objetos.Condicao']", 'unique': 'True', 'primary_key': 'True'}),
            'prefixo': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'prefixo_cji_avateres'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Avatar']"}),
            'sufixo': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'sufixo_cji_inst_obj'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.InstanciaObjeto']"})
        },
        'editor_objetos.condicaojogadorobjeto': {
            'Meta': {'object_name': 'CondicaoJogadorObjeto', '_ormbases': ['editor_objetos.Condicao']},
            'condicao_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['editor_objetos.Condicao']", 'unique': 'True', 'primary_key': 'True'}),
            'prefixo': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'prefixo_cjo_avateres'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Avatar']"}),
            'quantidade': ('django.db.models.fields.IntegerField', [], {'default': '1', 'max_length': '3'}),
            'sufixo': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'sufixo_cjo__obj'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Objeto']"})
        },
        'editor_objetos.enredo': {
            'Meta': {'object_name': 'Enredo'},
            'aventura': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'aventura_enredo'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Aventura']"}),
            'descricao': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'})
        },
        'editor_objetos.enredofile': {
            'Meta': {'object_name': 'EnredoFile', '_ormbases': ['editor_objetos.Enredo']},
            'enredo_file': ('django.db.models.fields.files.FileField', [], {'default': "''", 'max_length': '100'}),
            'enredo_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['editor_objetos.Enredo']", 'unique': 'True', 'primary_key': 'True'}),
            'tipo': ('django.db.models.fields.CharField', [], {'default': "'SAU'", 'max_length': '10'})
        },
        'editor_objetos.enredoinstancia': {
            'Meta': {'object_name': 'EnredoInstancia', '_ormbases': ['editor_objetos.Enredo']},
            'enredo_instancia': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'enredo_instancia'", 'blank': 'True', 'to': "orm['editor_objetos.InstanciaObjeto']"}),
            'enredo_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['editor_objetos.Enredo']", 'unique': 'True', 'primary_key': 'True'})
        },
        'editor_objetos.enredomensagem': {
            'Meta': {'object_name': 'EnredoMensagem', '_ormbases': ['editor_objetos.Enredo']},
        ...
        'editor_objetos.jogador': {
            'Meta': {'object_name': 'Jogador', '_ormbases': ['auth.User']},
            'dica_senha': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'nickname': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'user_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True', 'primary_key': 'True'})
        },
        'editor_objetos.mensagem': {
            ...
            'colaborativo': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'colaborativo'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Colaborativo']"}),
            'competitivo': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'competitivo'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Competitivo']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instancia_objeto': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'instancia_objeto'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.InstanciaObjeto']"}),
        ...
        'editor_objetos.missaoativa': {
            'Meta': {'object_name': 'MissaoAtiva'},
            'aventura_ativa_missao': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'aventura_ativa_missao'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.AventuraAtiva']"}),
            'estado_missao': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'missao': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'missao'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Missao']"})
        },
        'editor_objetos.mochila': {
            'Meta': {'object_name': 'Mochila'},
            'avatar_mochila': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'avatar_mochila'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.AvatarAtivo']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instancia_mochila': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'instancia_mochila'", 'default': "''", 'to': "orm['editor_objetos.InstanciaObjeto']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'})
        },
        'editor_objetos.nivelautor': {
            ...
            'aventura_autor': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'aventura_autor'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Aventura']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'editor_objetos.posinstanciaativa': {
            'Meta': {'object_name': 'PosInstanciaAtiva'},
            'altitude': ('django.db.models.fields.FloatField', [], {}),
            'aventura_ativa_instacia': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'aventura_ativa_instacia'", 'blank': 'True', 'to': "orm['editor_objetos.AventuraAtiva']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instancia_objeto_ativa': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'instancia_objeto_ativa'", 'blank': 'True', 'to': "orm['editor_objetos.InstanciaObjeto']"}),
            'latitude': ('django.db.models.fields.FloatField', [], {}),
            'longitude': ('django.db.models.fields.FloatField', [], {})
        },
