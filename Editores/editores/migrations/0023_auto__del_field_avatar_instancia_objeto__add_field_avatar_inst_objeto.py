...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Avatar.inst_objeto'
        db.add_column('editor_objetos_avatar', 'inst_objeto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='inst_objeto', null=True, blank=True, to=orm['editor_objetos.InstanciaObjeto']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Avatar.inst_objeto'
        db.delete_column('editor_objetos_avatar', 'inst_objeto_id')
