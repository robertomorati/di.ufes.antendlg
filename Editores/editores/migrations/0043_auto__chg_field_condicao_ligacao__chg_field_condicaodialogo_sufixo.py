...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Condicao.ligacao'
        db.alter_column('editor_objetos_condicao', 'ligacao', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'CondicaoDialogo.sufixo'
        db.alter_column('editor_objetos_condicaodialogo', 'sufixo', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Condicao.ligacao'
        db.alter_column('editor_objetos_condicao', 'ligacao', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'CondicaoDialogo.sufixo'
        db.alter_column('editor_objetos_condicaodialogo', 'sufixo', self.gf('django.db.models.fields.CharField')(max_length=10))
