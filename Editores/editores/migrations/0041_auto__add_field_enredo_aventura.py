...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Enredo.aventura'
        db.add_column('editor_objetos_enredo', 'aventura',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='aventura_enredo', null=True, blank=True, to=orm['editor_objetos.Aventura']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Enredo.aventura'
        db.delete_column('editor_objetos_enredo', 'aventura_id')
