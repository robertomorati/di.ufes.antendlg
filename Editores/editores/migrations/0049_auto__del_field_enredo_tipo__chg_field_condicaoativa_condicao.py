...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Enredo.tipo'
        db.delete_column('editor_objetos_enredo', 'tipo')


        # Changing field 'CondicaoAtiva.condicao'
        db.alter_column('editor_objetos_condicaoativa', 'condicao_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['editor_objetos.Condicao']))

    def backwards(self, orm):
        # Adding field 'Enredo.tipo'
        db.add_column('editor_objetos_enredo', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default='STX', max_length=10),
                      keep_default=False)


        # Changing field 'CondicaoAtiva.condicao'
        db.alter_column('editor_objetos_condicaoativa', 'condicao_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['editor_objetos.MissaoAtiva']))
