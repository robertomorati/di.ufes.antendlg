...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Aventura.autoria'
        db.delete_column(u'editores_aventura', 'autoria')

        # Adding field 'Aventura.autoria_estado'
        db.add_column(u'editores_aventura', 'autoria_estado',
                      self.gf('django.db.models.fields.CharField')(default=u'AI', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Aventura.autoria'
        db.add_column(u'editores_aventura', 'autoria',
                      self.gf('django.db.models.fields.CharField')(default=u'AI', max_length=10),
                      keep_default=False)

        # Deleting field 'Aventura.autoria_estado'
        db.delete_column(u'editores_aventura', 'autoria_estado')
