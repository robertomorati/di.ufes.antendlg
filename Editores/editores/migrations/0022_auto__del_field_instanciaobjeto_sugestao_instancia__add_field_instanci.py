...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InstanciaObjeto.sugestao_instancia'
        db.delete_column(u'editores_instanciaobjeto', 'sugestao_instancia_id')
    ...
    def backwards(self, orm):
        # Adding field 'InstanciaObjeto.sugestao_instancia'
        db.add_column(u'editores_instanciaobjeto', 'sugestao_instancia',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='sugestoes', null=True, to=orm['editores.Sugestao'], blank=True),
                      keep_default=False)
