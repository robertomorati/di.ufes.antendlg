...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PosicaoGeografica.pos_count'
        db.add_column(u'editores_posicaogeografica', 'pos_count',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PosicaoGeografica.pos_count'
        db.delete_column(u'editores_posicaogeografica', 'pos_count')
    ...
    models = {
        ...
        u'editores.posicaogeografica': {
            ...
            'pos_count': ('django.db.models.fields.IntegerField', [], {'default': '1', 'max_length': '100'})
        },
