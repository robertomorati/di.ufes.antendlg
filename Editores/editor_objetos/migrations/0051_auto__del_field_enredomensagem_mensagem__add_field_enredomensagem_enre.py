...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EnredoMensagem.mensagem'
        db.delete_column('editor_objetos_enredomensagem', 'mensagem')
    ...
    def backwards(self, orm):
        # Adding field 'EnredoMensagem.mensagem'
        db.add_column('editor_objetos_enredomensagem', 'mensagem',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)
