...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('editor_objetos_colaborativo', (
            ('comportamento_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editor_objetos.Comportamento'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('editor_objetos', ['Colaborativo'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('editor_objetos_colaborativo')
    ...
    models = {
        ...
        'editor_objetos.colaborativo': {
            ...
            'comportamento_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['editor_objetos.Comportamento']", 'unique': 'True', 'primary_key': 'True'}),
            'obstaculoscl': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'obstaculoscl'", 'default': "''", 'to': "orm['editor_objetos.InstanciaObjeto']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'})
        },
        'editor_objetos.competitivo': {
            'Meta': {'object_name': 'Competitivo', '_ormbases': ['editor_objetos.Comportamento']},
            'comportamento_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['editor_objetos.Comportamento']", 'unique': 'True', 'primary_key': 'True'}),
            'obstaculoscp': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'obstaculoscp'", 'default': "''", 'to': "orm['editor_objetos.InstanciaObjeto']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'})
        },
