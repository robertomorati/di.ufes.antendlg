...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Avatar.aventura_avatar'
        db.alter_column('editor_objetos_avatar', 'aventura_avatar_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['editor_objetos.Aventura']))

        # Changing field 'Avatar.instancia_objeto'
        db.alter_column('editor_objetos_avatar', 'instancia_objeto_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['editor_objetos.InstanciaObjeto']))

    def backwards(self, orm):

        # Changing field 'Avatar.aventura_avatar'
        db.alter_column('editor_objetos_avatar', 'aventura_avatar_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor_objetos.Aventura']))

        # Changing field 'Avatar.instancia_objeto'
        db.alter_column('editor_objetos_avatar', 'instancia_objeto_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor_objetos.InstanciaObjeto']))
    ...
    models = {
        ...
        'editor_objetos.avatar': {
            ...
            'aventureiro': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'aventureiro'", 'blank': 'True', 'to': "orm['editor_objetos.Jogador']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
