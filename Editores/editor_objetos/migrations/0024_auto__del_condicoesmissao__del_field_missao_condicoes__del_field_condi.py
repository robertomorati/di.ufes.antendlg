...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Missao.condicoes'
        db.delete_column('editor_objetos_missao', 'condicoes_id')

        # Deleting field 'Condicao.condicoes_missao'
        db.delete_column('editor_objetos_condicao', 'condicoes_missao_id')

        # Adding field 'Condicao.missao'
        db.add_column('editor_objetos_condicao', 'missao',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='condicoes_missao', null=True, blank=True, to=orm['editor_objetos.Missao']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Missao.condicoes'
        db.add_column('editor_objetos_missao', 'condicoes',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='condicoes', null=True, to=orm['editor_objetos.CondicoesMissao'], blank=True),
                      keep_default=False)

        # Adding field 'Condicao.condicoes_missao'
        db.add_column('editor_objetos_condicao', 'condicoes_missao',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='condicoes_missao', null=True, to=orm['editor_objetos.CondicoesMissao'], blank=True),
                      keep_default=False)

        # Deleting field 'Condicao.missao'
        db.delete_column('editor_objetos_condicao', 'missao_id')
