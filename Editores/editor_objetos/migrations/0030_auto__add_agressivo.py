...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('editor_objetos_agressivo', (
            ...
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='instancia_agressivo', null=True, blank=True, to=orm['editor_objetos.InstanciaObjeto'])),
        ))
        db.send_create_signal('editor_objetos', ['Agressivo'])


    def backwards(self, orm):
        # Deleting model 'Agressivo'
        db.delete_table('editor_objetos_agressivo')
