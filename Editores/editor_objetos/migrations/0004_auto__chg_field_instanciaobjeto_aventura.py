...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstanciaObjeto.aventura'
        db.alter_column('editor_objetos_instanciaobjeto', 'aventura_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['editor_objetos.Aventura']))

    def backwards(self, orm):

        # Changing field 'InstanciaObjeto.aventura'
        db.alter_column('editor_objetos_instanciaobjeto', 'aventura_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor_objetos.Aventura']))
