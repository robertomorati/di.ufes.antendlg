...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('editor_objetos_competitivo')

        # Removing M2M table for field obstaculoscp on 'Competitivo'
        db.delete_table('editor_objetos_competitivo_obstaculoscp')

        # Adding field 'Mensagem.instancia_objeto'
        db.add_column('editor_objetos_mensagem', 'instancia_objeto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='instancia_objeto', null=True, blank=True, to=orm['editor_objetos.InstanciaObjeto']),
                      keep_default=False)

        # Adding field 'Mensagem.colaborativo'
        db.add_column('editor_objetos_mensagem', 'colaborativo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='colaborativo', null=True, blank=True, to=orm['editor_objetos.Colaborativo']),
                      keep_default=False)

        # Removing M2M table for field obstaculoscl on 'Colaborativo'
        db.delete_table('editor_objetos_colaborativo_obstaculoscl')


    def backwards(self, orm):
        # Adding model 'Competitivo'
        db.create_table('editor_objetos_competitivo', (
        ...
        db.send_create_signal('editor_objetos', ['Competitivo'])

        # Adding M2M table for field obstaculoscp on 'Competitivo'
        db.create_table('editor_objetos_competitivo_obstaculoscp', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('competitivo', models.ForeignKey(orm['editor_objetos.competitivo'], null=False)),
            ('instanciaobjeto', models.ForeignKey(orm['editor_objetos.instanciaobjeto'], null=False))
        ))
        db.create_unique('editor_objetos_competitivo_obstaculoscp', ['competitivo_id', 'instanciaobjeto_id'])

        # Deleting field 'Mensagem.instancia_objeto'
        db.delete_column('editor_objetos_mensagem', 'instancia_objeto_id')

        # Deleting field 'Mensagem.colaborativo'
        db.delete_column('editor_objetos_mensagem', 'colaborativo_id')

        # Adding M2M table for field obstaculoscl on 'Colaborativo'
        db.create_table('editor_objetos_colaborativo_obstaculoscl', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('colaborativo', models.ForeignKey(orm['editor_objetos.colaborativo'], null=False)),
            ('instanciaobjeto', models.ForeignKey(orm['editor_objetos.instanciaobjeto'], null=False))
        ))
        db.create_unique('editor_objetos_colaborativo_obstaculoscl', ['colaborativo_id', 'instanciaobjeto_id'])
