...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Avatar.publico'
        db.add_column('editor_objetos_avatar', 'publico',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Avatar.aventureiro'
        db.alter_column('editor_objetos_avatar', 'aventureiro_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor_objetos.Jogador']))

    def backwards(self, orm):
        # Deleting model 'Jogador'
        db.delete_table('editor_objetos_jogador')

        # Deleting field 'Avatar.publico'
        db.delete_column('editor_objetos_avatar', 'publico')


        # Changing field 'Avatar.aventureiro'
        db.alter_column('editor_objetos_avatar', 'aventureiro_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor_objetos.Autor']))
