...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('editor_objetos_enredoinstancia', (
            ('enredo_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editor_objetos.Enredo'], unique=True, primary_key=True)),
            ('enredo_instancia', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='enredo_instancia', blank=True, to=orm['editor_objetos.InstanciaObjeto'])),
        ))
        db.send_create_signal('editor_objetos', ['EnredoInstancia'])

        # Adding model 'EnredoFile'
        db.create_table('editor_objetos_enredofile', (
            ('enredo_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editor_objetos.Enredo'], unique=True, primary_key=True)),
            ('enredo_file', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100)),
        ))
        db.send_create_signal('editor_objetos', ['EnredoFile'])

        # Adding model 'EnredoMensagem'
        db.create_table('editor_objetos_enredomensagem', (
            ('enredo_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['editor_objetos.Enredo'], unique=True, primary_key=True)),
            ('mensagem', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
        ))
        db.send_create_signal('editor_objetos', ['EnredoMensagem'])

        # Deleting field 'Enredo.enredo'
        db.delete_column('editor_objetos_enredo', 'enredo')


    def backwards(self, orm):
        # Deleting model 'EnredoInstancia'
        db.delete_table('editor_objetos_enredoinstancia')

        # Deleting model 'EnredoFile'
        db.delete_table('editor_objetos_enredofile')

        # Deleting model 'EnredoMensagem'
        db.delete_table('editor_objetos_enredomensagem')

        # Adding field 'Enredo.enredo'
        db.add_column('editor_objetos_enredo', 'enredo',
