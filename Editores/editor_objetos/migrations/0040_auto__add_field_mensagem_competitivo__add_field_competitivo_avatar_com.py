...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mensagem.competitivo'
        db.add_column('editor_objetos_mensagem', 'competitivo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='competitivo', null=True, blank=True, to=orm['editor_objetos.Competitivo']),
                      keep_default=False)

        # Adding field 'Competitivo.avatar_comp'
        db.add_column('editor_objetos_competitivo', 'avatar_comp',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='avatar_comp', null=True, blank=True, to=orm['editor_objetos.Avatar']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mensagem.competitivo'
        db.delete_column('editor_objetos_mensagem', 'competitivo_id')

        # Deleting field 'Competitivo.avatar_comp'
        db.delete_column('editor_objetos_competitivo', 'avatar_comp_id')
