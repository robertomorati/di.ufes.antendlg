...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Condicao.evento'
        db.delete_column('editor_objetos_condicao', 'evento')
    ...
    def backwards(self, orm):
        # Adding field 'Condicao.evento'
        db.add_column('editor_objetos_condicao', 'evento',
                      self.gf('django.db.models.fields.CharField')(default='GET_OBJ', max_length=10),
                      keep_default=False)


        # Changing field 'Condicao.ligacao'
        db.alter_column('editor_objetos_condicao', 'ligacao', self.gf('django.db.models.fields.CharField')(max_length=30))
