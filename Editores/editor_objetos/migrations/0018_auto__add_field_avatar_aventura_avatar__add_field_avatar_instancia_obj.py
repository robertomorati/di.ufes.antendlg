...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Avatar.aventura_avatar'
        db.add_column('editor_objetos_avatar', 'aventura_avatar',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='aventura_avatar', blank=True, to=orm['editor_objetos.Aventura']),
                      keep_default=False)

        # Adding field 'Avatar.instancia_objeto'
        db.add_column('editor_objetos_avatar', 'instancia_objeto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='instancia_objeto', blank=True, to=orm['editor_objetos.InstanciaObjeto']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Avatar.aventura_avatar'
        db.delete_column('editor_objetos_avatar', 'aventura_avatar_id')

        # Deleting field 'Avatar.instancia_objeto'
        db.delete_column('editor_objetos_avatar', 'instancia_objeto_id')
    ...
    models = {
        ...
        'editor_objetos.avatar': {
            ...
            'aventura_avatar': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'aventura_avatar'", 'blank': 'True', 'to': "orm['editor_objetos.Aventura']"}),
            'aventureiro': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'jogador'", 'blank': 'True', 'to': "orm['editor_objetos.Jogador']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instancia_objeto': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'instancia_objeto'", 'blank': 'True', 'to': "orm['editor_objetos.InstanciaObjeto']"}),
        ...
        'editor_objetos.missao': {
            ...
            'condicoes': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'condicoes'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.CondicoesMissao']"}),
