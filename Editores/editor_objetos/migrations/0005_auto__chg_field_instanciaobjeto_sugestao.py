...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstanciaObjeto.sugestao'
        db.alter_column('editor_objetos_instanciaobjeto', 'sugestao_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['editor_objetos.Sugestao']))

    def backwards(self, orm):

        # Changing field 'InstanciaObjeto.sugestao'
        db.alter_column('editor_objetos_instanciaobjeto', 'sugestao_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor_objetos.Sugestao']))
