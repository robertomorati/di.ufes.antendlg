...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AvatarAtivo.avatar'
        db.add_column('editor_objetos_avatarativo', 'avatar',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='avatar_ativo', null=True, blank=True, to=orm['editor_objetos.Avatar']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'AvatarAtivo.avatar'
        db.delete_column('editor_objetos_avatarativo', 'avatar_id')

        # Adding field 'Avatar.avatar_ativo'
        db.add_column('editor_objetos_avatar', 'avatar_ativo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='avatar_ativo', null=True, to=orm['editor_objetos.AvatarAtivo'], blank=True),
                      keep_default=False)
