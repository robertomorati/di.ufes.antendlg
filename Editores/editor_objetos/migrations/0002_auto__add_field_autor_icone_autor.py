...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Autor.icone_autor'
        db.add_column('editor_objetos_autor', 'icone_autor',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Autor.icone_autor'
        db.delete_column('editor_objetos_autor', 'icone_autor')
