...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EnredoInstancia.enredo_instancia'
        db.delete_column('editor_objetos_enredoinstancia', 'enredo_instancia_id')

        # Adding field 'EnredoInstancia.enredo'
        db.add_column('editor_objetos_enredoinstancia', 'enredo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='enredo_instancia', blank=True, to=orm['editor_objetos.InstanciaObjeto']),
                      keep_default=False)

        # Deleting field 'EnredoFile.enredo_file'
        db.delete_column('editor_objetos_enredofile', 'enredo_file')

        # Adding field 'EnredoFile.enredo'
        db.add_column('editor_objetos_enredofile', 'enredo',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'EnredoMensagem.enredo_mensagem'
        db.delete_column('editor_objetos_enredomensagem', 'enredo_mensagem')

        # Adding field 'EnredoMensagem.enredo'
        db.add_column('editor_objetos_enredomensagem', 'enredo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EnredoInstancia.enredo_instancia'
        db.add_column('editor_objetos_enredoinstancia', 'enredo_instancia',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='enredo_instancia', to=orm['editor_objetos.InstanciaObjeto'], blank=True),
                      keep_default=False)

        # Deleting field 'EnredoInstancia.enredo'
        db.delete_column('editor_objetos_enredoinstancia', 'enredo_id')

        # Adding field 'EnredoFile.enredo_file'
        db.add_column('editor_objetos_enredofile', 'enredo_file',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'EnredoFile.enredo'
        db.delete_column('editor_objetos_enredofile', 'enredo')

        # Adding field 'EnredoMensagem.enredo_mensagem'
        db.add_column('editor_objetos_enredomensagem', 'enredo_mensagem',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Deleting field 'EnredoMensagem.enredo'
        db.delete_column('editor_objetos_enredomensagem', 'enredo')
    ...
    models = {
        ...
        'editor_objetos.enredoinstancia': {
            ...
            'enredo': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'enredo_instancia'", 'blank': 'True', 'to': "orm['editor_objetos.InstanciaObjeto']"}),
            'enredo_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['editor_objetos.Enredo']", 'unique': 'True', 'primary_key': 'True'})
        },
        'editor_objetos.enredomensagem': {
            'Meta': {'object_name': 'EnredoMensagem', '_ormbases': ['editor_objetos.Enredo']},
            'enredo': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
            'enredo_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['editor_objetos.Enredo']", 'unique': 'True', 'primary_key': 'True'})
        },
