...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NivelAutor.autor'
        db.add_column('editor_objetos_nivelautor', 'autor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='autor', null=True, blank=True, to=orm['editor_objetos.Autor']),
                      keep_default=False)

        # Adding field 'NivelAutor.aventura'
        db.add_column('editor_objetos_nivelautor', 'aventura',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='aventura', null=True, blank=True, to=orm['editor_objetos.Aventura']),
                      keep_default=False)

        # Adding field 'NivelAutor.nivel'
        db.add_column('editor_objetos_nivelautor', 'nivel',
                      self.gf('django.db.models.fields.CharField')(default='Principal', max_length=1),
                      keep_default=False)


        # Changing field 'TipoImagem.tipo'
        db.alter_column('editor_objetos_tipoimagem', 'tipo', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):
        # Deleting field 'NivelAutor.autor'
        db.delete_column('editor_objetos_nivelautor', 'autor_id')

        # Deleting field 'NivelAutor.aventura'
        db.delete_column('editor_objetos_nivelautor', 'aventura_id')

        # Deleting field 'NivelAutor.nivel'
        db.delete_column('editor_objetos_nivelautor', 'nivel')


        # Changing field 'TipoImagem.tipo'
        db.alter_column('editor_objetos_tipoimagem', 'tipo', self.gf('django.db.models.fields.CharField')(max_length=1))
