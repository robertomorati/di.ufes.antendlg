...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('editor_objetos_jogador_aventura', (
        ...
        db.create_unique('editor_objetos_jogador_aventura', ['jogador_id', 'aventura_id'])


    def backwards(self, orm):
        # Removing M2M table for field aventura on 'Jogador'
        db.delete_table('editor_objetos_jogador_aventura')
    ...
    models = {
        ...
        'editor_objetos.jogador': {
            ...
            'aventura': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'aventuras_jogador'", 'symmetrical': 'False', 'to': "orm['editor_objetos.Aventura']"}),
