...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CondicoesMissao'
        db.create_table('editor_objetos_condicoesmissao', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nomeComposicao', self.gf('django.db.models.fields.CharField')(default='', max_length=30)),
            ('missao', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='missoes', null=True, blank=True, to=orm['editor_objetos.Missao'])),
        ))
        db.send_create_signal('editor_objetos', ['CondicoesMissao'])

        # Adding model 'Missao'
        db.create_table('editor_objetos_missao', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('enredo', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='enredo_missao', null=True, blank=True, to=orm['editor_objetos.Enredo'])),
            ('aventuras', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='aventuras', null=True, blank=True, to=orm['editor_objetos.Aventura'])),
        ))
        db.send_create_signal('editor_objetos', ['Missao'])

        # Adding field 'Avatar.aventureiro'
        db.add_column('editor_objetos_avatar', 'aventureiro',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='aventureiro', blank=True, to=orm['editor_objetos.Autor']),
                      keep_default=False)

        # Adding field 'Condicao.condicoes_missao'
        db.add_column('editor_objetos_condicao', 'condicoes_missao',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='condicoes_missao', null=True, blank=True, to=orm['editor_objetos.CondicoesMissao']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CondicoesMissao'
        db.delete_table('editor_objetos_condicoesmissao')

        # Deleting model 'Missao'
        db.delete_table('editor_objetos_missao')

        # Deleting field 'Avatar.aventureiro'
        db.delete_column('editor_objetos_avatar', 'aventureiro_id')

        # Deleting field 'Condicao.condicoes_missao'
        db.delete_column('editor_objetos_condicao', 'condicoes_missao_id')
    ...
    models = {
        ...
        'editor_objetos.avatar': {
            ...
            'aventureiro': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'aventureiro'", 'blank': 'True', 'to': "orm['editor_objetos.Autor']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'editor_objetos.condicao': {
            ...
            'condicoes_missao': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'condicoes_missao'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.CondicoesMissao']"}),
        ...
        'editor_objetos.condicoesmissao': {
            'Meta': {'object_name': 'CondicoesMissao'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'missao': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'missoes'", 'null': 'True', 'blank': 'True', 'to': "orm['editor_objetos.Missao']"}),
            'nomeComposicao': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'})
        },
