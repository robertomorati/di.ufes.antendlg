...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aventura.autor'
        db.add_column('editor_objetos_aventura', 'autor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='Autor', to=orm['editor_objetos.Autor']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aventura.autor'
        db.delete_column('editor_objetos_aventura', 'autor_id')
    ...
    models = {
        ...
        'editor_objetos.aventura': {
            ...
            'autor': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'Autor'", 'to': "orm['editor_objetos.Autor']"}),
