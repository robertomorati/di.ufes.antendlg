...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InstanciaObjeto.num_instancia'
        db.delete_column('editor_objetos_instanciaobjeto', 'num_instancia')
    ...
    def backwards(self, orm):
        # Adding field 'InstanciaObjeto.num_instancia'
        db.add_column('editor_objetos_instanciaobjeto', 'num_instancia',
